...
public class AddHyperlinkInPDFFile {
    ...
    public static void addHyperlinkInPDFFile(String dataDir, String outputDir) {
        ...
        try {
            ...
            FreeTextAnnotation textAnnotation = new FreeTextAnnotation(doc.getPages().get_Item(1),
                    new Rectangle(100, 100, 300, 300),
                    new DefaultAppearance(FontRepository.findFont("Arial"), 10, java.awt.Color.BLUE));
