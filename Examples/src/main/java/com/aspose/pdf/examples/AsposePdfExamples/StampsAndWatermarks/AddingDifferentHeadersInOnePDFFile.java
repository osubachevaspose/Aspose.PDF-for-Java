...
public class AddingDifferentHeadersInOnePDFFile {
    ...
    public static void runExamples() {
        ...
        addingDifferentHeadersInOnePDFFile(outputDir);
        System.out.println("Example addingDifferentHeadersInOnePDFFile end");
    }

    public static void addingDifferentHeadersInOnePDFFile(String outputDir) {
        ...
        try {
            ...
            doc.save(outputDir + "multiheader.pdf");
        } finally {
            if (doc != null)
                doc.close();
        }
